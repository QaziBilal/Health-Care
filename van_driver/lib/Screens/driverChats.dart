...
import 'package:van_driver/Screens/singleChat.dart';
import 'package:van_driver/Widgets/Badge.dart';
...
class DriverChats extends StatelessWidget {
  ...
  Widget customChat(context, bool isUnread) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => SingleChat()));
      },
      child: Container(
